...
const AddCustomer = props => {
    ...
    return <div className = {Styles.addcustomer}>
        <button className = {Styles.addcustomer__label} onClick = {handleShowingTheForm}>Add new Customer</button>

        <form className = {Styles.addcustomer__form} onSubmit = {props.handleSubmit(handlSubmit)} ref = {formEl}>
            <div className = {Styles.addcustomer__form__input}>
                ...
                <div className = {Styles.addcustomer__form__input__input}>
                    <Field component = 'input' type = 'checkbox' name = 'isCompany' id = 'isCompany'/>
                    
                </div>
            </div>
            <span className = {Styles.addcustomer__form__cancelbutton} onClick = {hideForm}>cancel</span>
            ...
            <Field component = {renderField} name = 'mobile' type = 'tel' label = 'Mobile' />
            <Field component = {renderField} name = 'address' type = 'text' label = 'Address' />
            <Field component = {renderField} name = 'city' type = 'text' label = 'City' />
            <Field component = {renderField} name = 'state' type = 'text' label = 'State/Country' />
            <Field component = {renderField} name = 'zipCode' type = 'text' label = 'Post/Zip code' className = {Styles.addcustomer__form__input__inputHalf} />
            <div className = {Styles.addcustomer__form__input}>
            
                <div className = {Styles.addcustomer__form__input__label}>
                </div>
                <div className = {`${Styles.addcustomer__form__input__input} ${Styles.addcustomer__form__input__inputCheck}`}>
                    <label htmlFor = 'isSiteAddress'>Also make site Address</label>
                    <Field component = 'input' type = 'checkbox' name = 'isSiteAddress' id = 'isSiteAddress'/>
