...
const TermsAndConditions = ({ isModalOpened, closeModal }) => {
  ...
  return (
    <TermsModal isModalOpened={isModalOpened}>
      <div className={Styles.terms}>
        ...
        <div
          className={` ${Styles.terms__container} ${Styles.terms__document}`}
        >
        ...
        >
          <p>
            ...
            subdomain you agree to be bound by the following terms and
          ...
          <p>
            ...
            to such changes. You can review the most current version of the
            Terms of Service at any time here: www.wewurx.com/terms-conditions/
          </p>
          <p>
            Violation of any of the terms below will result in the termination
            of your Account. While WeWurx prohibits such conduct and Content on
            the Service, you understand and agree that WeWurx cannot be
        ...
        >
          ...
          <p>
            Your login may only be used by one person and a single login shared
